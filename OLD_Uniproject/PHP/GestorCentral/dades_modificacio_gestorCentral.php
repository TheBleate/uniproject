<html>
  ...
  <body>
    ...
    <a href="../../gestorCentral.html"><input type="submit" value="Torna al principi" name="button"></input>
  </body>
...
session_start();
GestorCentral::modificarGestorCentral($_POST['id'],$_POST['nom_nou'],$_POST['usuari_nou'], $_POST['contrasenya_nova']);
