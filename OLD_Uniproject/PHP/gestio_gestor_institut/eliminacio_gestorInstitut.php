...
<html>
  ...
  <body>
    ...
    <h2 class ="h2_creacio">Eliminació dels gestors d'Instituts</h2>
    <p class ="p_creacio">Elimina els gestors dels instituts</p>
    <form action="dades_eliminacio_gestorInstitut.php" method="post">
      <div class="flexbox-container">
        <label for="id">Posa l'id a eliminar</label>
        <br>
