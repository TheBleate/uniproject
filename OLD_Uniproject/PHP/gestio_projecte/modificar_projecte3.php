...
<div>
<a name="titolprincipi"><h1 class="titolprincipal">Modificar Projecte</h1></a>
...
<?php
    ...
    $projecte_a_modificar->setNom("$nom_projecte");
    $projecte_a_modificar->setNom_empresa_centre("$nom_empresa_centre");
    $projecte_a_modificar->setTelefon("$telefon");
    $projecte_a_modificar->setEmail("$email");
    $projecte_a_modificar->setMunicipi("$municipi");
    $projecte_a_modificar->setCategoria("$categoria");
    $projecte_a_modificar->setComentari("$comentari");
