...
<div>
<a name="titolprincipi"><h1 class="titolprincipal">Eliminar Projecte</h1></a>
...
<br>
<form action="eliminar_projecte.php" method="post">
<label for="posicio_modificar">Posició del projecte que vols eliminar</label>
<input type="text" id="identificador" name="identificador" placeholder="Posició Projecte..." requerid></input>
