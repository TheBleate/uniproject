...
<body>
    ...
    <div>
        ...
        <a name="titolprincipi"><h1 class="titolprincipal">Modificar Empresa</h1></a>
            ...
            <?php
            //Aquest fitxer php mostrar la llista i demanar quina empresa eliminar
        ...
        <form action="modificar_empresa2.php" method="post">
        <label for="posicio_modificar">ID de l'empresa a modificar</label>
        <input type="text" id="identificador" name="identificador" placeholder="ID de l'Empresa..." requerid></input>
        ...
        <button type="submit" class="botoroig" formaction="llistar_empresa.php" required>Llistar</button>
