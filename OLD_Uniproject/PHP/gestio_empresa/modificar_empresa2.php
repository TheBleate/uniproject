...
<div>
<a name="titolprincipi"><h1 class="titolprincipal">Modificar Empresa</h1></a>
...
session_start();
    ...
    $empresa_a_modificar = $_SESSION['empresa'][$_POST['identificador']];
?>

<form action="modificar_empresa3.php" method="post">
...
<form>
    ...
    <input id="identificador" name="identificador" type="hidden" value="<?php echo $_POST['identificador'];?>">
        ...
        <br>
        <input type="text" id="nom" name="nom" placeholder="Introduir nom de l'empresa" value="<?php echo $empresa_a_modificar->getNom();?>" required></input>
      </div>
        <div>
          <label for = "nom centre">Localitat</label>
          <br>
          <input type="text" id="localitat" name="localitat" placeholder="Localitat" value="<?php echo $empresa_a_modificar->getLocalitat();?>" required></input>
        </div>
    </div>
    <div class = "flexbox-container">
      <div>
        ...
        <br>
        <input class="columna_dreta" type="tel" id="telefon" name="telefon" placeholder="Introduir telèfon" value="<?php echo $empresa_a_modificar->getTelefon();?>" required></input>
      </div>
        <div>
          <label  class="columna_esquerra" for = "email">Email</label>
          <br>
          <input class="columna_dreta" type="email" id="email" name="email" placeholder="Introduir email" value="<?php echo $empresa_a_modificar->getEmail();?>" required></input>
        </div>
