...
<a name="titolprincipi"><h1 class="titolprincipal">Modificar Empresa</h1></a>
  ...
  <p class ="text_pagina">Consulta la llista si s'ha modificat correctament l'usuari</p>
...
<?php
    ...
    $empresa_a_modificar->setNom("$nom");
    $empresa_a_modificar->setLocalitat("$localitat");
    $empresa_a_modificar->setTelefon("$telefon");
    $empresa_a_modificar->setEmail("$email");
