...
<div>
<a name="titolprincipi"><h1 class="titolprincipal">Eliminar Empresa</h1></a>
...
<label for="posicio_modificar">Posició de l'empresa que vols eliminar</label>
<input type="text" id="identificador" name="identificador" placeholder="Posició Empresa..." requerid></input>
